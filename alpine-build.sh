...
apk add util-linux pciutils hwdata-pci usbutils hwdata-usb coreutils binutils findutils grep iproute2 vim wget findutils-locate linux-firmware-radeon linux-firmware-amdgpu git make cmake libstdc++ gcc g++ automake libtool autoconf linux-headers ufw logrotate hwloc-tools btop
...
apk add lm-sensors lm-sensors-detect lm-sensors-doc lm-sensors-fancontrol lm-sensors-sensord


cat <<EOF> /etc/modules-load.d/lm_sensors.conf
# Generated by sensors-detect on Thu Jun  6 12:56:15 2024
it87
EOF
